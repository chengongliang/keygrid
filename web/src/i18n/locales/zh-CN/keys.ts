...
const keys = {
  ...
  providerLimitOptional: '渠道限制（可选，不勾选 = 全部渠道）',
  ...
  providerLimit: '渠道限制（不勾选 = 不限）',
  providerLimitHint: '该 Key 的请求只路由到勾选的渠道；模型匹配、优先级与故障转移规则不变。',
  providerDeleted: '已删除',
  noProviderForBinding: '还没有渠道，先到「我的供应商」页添加。',
  providerOrphanHint: '有 {{count}} 个已删除渠道的绑定，保存后自动清除。',
